...
//            String tmb[] = cmbClothes.split("-");
//            String id = tmb[0];
//            String name = tmb[1];
//            double gia =  Double.parseDouble(tmb[2]);
...
//            Clothes clothes = new Clothes(id, name, quantity, gia);
            ...
            boolean checkAdd = cart.add(dto);

            if (checkAdd) {
                session.setAttribute("CART", cart);
                request.setAttribute("ADD_CART_MESSAGE", "You have succesfully added " + dto.getName() + " with quantity " + quantity);
                url = SUCCESS;
            }
