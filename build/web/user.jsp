...
<body>
    <div class="container">
        <div class="profile-container">
            ...
            <a href="MainController?action=Shopping_Product_Page" class="btn btn-primary shopping-button">Start Shopping</a>
            <a href="MainController?action=Logout" class="btn btn-danger mt-3">Logout</a>
        </div>
    </div>
